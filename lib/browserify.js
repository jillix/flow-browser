...
module.exports = function (production, target, module, callback) {
    ...
    fs.open(target, 'r', (err, fd) => {
        ...
        if (err && err.code === "ENOENT") {
            return createBundle(production, modules[module_name]);
        }
...
function createBundle (production, module) {
    ...
    production && b.transform(uglify, {global: true});
